/* Edit this one file to update both collections. Milestone dates are MM/YY or null (pending / ongoing).
   Project theme colors must stay inside the project media frame. Do not use them for site UI.
   Concept is a single date; rnd/testing have start/end dates; launch has an actual date OR anticipated window.
   Set start to MM/YY when a phase begins; set end to MM/YY when finished. Leave dates null until then.
   The current state is calculated automatically; instructions are in README.md.
   Never put private repository URLs, secrets, or API keys on a public portfolio. */
window.PORTFOLIO_PROJECTS = {
  compound: [
    {
      id: 'syncora', name: 'Project Syncora', category: 'Creative software',
    ...
    {
      id: 'sentry', name: 'Project Sentry', category: 'Home network / Infrastructure',
      ...
      phases: {
        concept: '09/26',
        rnd: { start: null, end: null },
        testing: { start: null, end: null },
        launch: { date: null, anticipated: 'Early 2027' }
      },
  ...
  watchtower: [
    {
      id: 'dex', name: 'DEX', category: 'Development assistant',
    ...
    {
      id: 'robert', name: 'ROBERT', category: 'Security assistant',
      ...
      rndNote: 'Awaiting completion of Project Sentry.',
