  ...
  compound: [
    {
      ...
      artCaption: 'CONCEPT ART / AUDIO → EDITING SIGNAL',
    ...
    {
      id: 'sentry', name: 'SENTRY', category: 'HOME SECURITY / INFRASTRUCTURE', status: 'R&D',
      ...
      artCaption: 'CONCEPT ART / NETWORK PERIMETER',
  ...
  watchtower: [
    {
      ...
      artCaption: 'CONCEPT ART / AGENT VISUALIZER',
    ...
    },
    {
      ...
      how: 'ROBERT is conceived as an interface and reasoning layer for purpose-built security tools running inside SENTRY. Its proposed responsibilities include observations, contextual triage, and human-readable explanations; deployment and capability details are still in development.',
      ...
      artCaption: 'CONCEPT ART / TELEMETRY INTERFACE',
